...
int leituraDados(FILE *arquivo, Aluno *vetorDados, int *leitura) {
...
bool readAlunoLine(FILE *arquivo, Aluno *a, int *leitura) {
...
void escreveAluno(FILE *arquivo, Aluno *a, int *escrita) {
