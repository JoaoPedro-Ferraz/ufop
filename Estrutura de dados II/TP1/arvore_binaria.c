...
// Função auxiliar para ler um nó da árvore pela posição.
...
// Função auxiliar para escrever um nó da árvore em uma posição específica.
...
// Vai navegando até achar a posição correta e atualiza os ponteiros simulados.
...
// Busca na árvore binária externa.
